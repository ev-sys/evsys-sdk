...
from trajectory_experiments.algorithms import ComboAlgorithm, GEPAPromptAlgorithm
from trajectory_experiments.log_stores.jsonl import JSONLLogStore
from trajectory_experiments.protocols import RunContext
from trajectory_experiments.registry import (
    get_algorithm,
    register_algorithm,
)
    ...
    def test_phase_artifacts_threaded_forward(self, tmp_path: Path):
        ...
        class CaptureInit:
            ...
            def train(self, ctx):
                ...
                from trajectory_experiments.protocols import RunResult
        ...
        try:
            ...
            from trajectory_experiments.registry import _algorithms
