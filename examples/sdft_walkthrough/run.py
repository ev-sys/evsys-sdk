"""SDFT walkthrough runner — loads config.yaml and runs the experiment.
...
wiring with no GPU / network / cost, validate instead:
    ...
    .venv/bin/evsys validate examples/sdft_walkthrough/config.yaml --deep
"""
