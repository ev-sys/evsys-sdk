...
def register_deployer(name: str | None = None):
    return _deployers.register(name)
...
def get_deployer(name: str) -> type:
    return _deployers.get(name)
...
def list_deployers() -> list[str]:
    return _deployers.list()
