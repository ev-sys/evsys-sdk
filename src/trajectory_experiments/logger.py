"""Configurable logging for the trajectory_experiments SDK.
...
Usage::
    ...
    from trajectory_experiments.logger import get_logger
...
def configure_logger(
    ...
    *,
    ...
    The SDK root logger is named ``trajectory_experiments``; per-module loggers
    ...
    logger.debug("trajectory_experiments logger configured | level=%s color=%s", resolved, color)
    return logger
