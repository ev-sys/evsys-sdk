---
title: Verifiers
description: Two reward mechanisms — the Verifier class registry and the in-process verifier-fn registry referenced from task data.
---
...
## (b) The in-process verifier-fn registry
