...
description: A complete, run-it-yourself RL walkthrough — tasks with verifiers as the reward, the built-in rl algorithm, rollouts via Harbor, in-loop validation, and local logging.
---
