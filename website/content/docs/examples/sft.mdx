...
description: A complete, run-it-yourself SFT walkthrough - JSONL data, a transform, the built-in sft algorithm, in-loop validation, and local logging, explained line by line.
---
...
SDK finds it in the registry by that name. See [Plugins](/docs/concepts/plugins/algorithms).
</Callout>
