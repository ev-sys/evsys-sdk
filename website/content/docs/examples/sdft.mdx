---
title: SDFT - Self-Distillation Fine-Tuning
description: A complete, run-it-yourself SDFT walkthrough - prompts with gold answers, a frozen teacher built from the same model, the built-in sdft algorithm, in-loop validation, and local logging.
---
...
## 1. The raw data - prompts you point the config at
...
## 2. How the teacher works (no extra config)
...
## 4. Benchmarks & validation - score it *during* training
